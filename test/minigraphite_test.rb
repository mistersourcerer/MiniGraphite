...
class MiniGraphiteTest < MiniTest::Unit::TestCase
	...
	def test_datapoint
		...
		Dalia::MiniGraphite::Log.any_instance.expects(:log_signal).with("test.age 31 1357117860\n")
	...
	def test_counter
		...
		Dalia::MiniGraphite::Log.any_instance.expects(:log_signal).with("height:231|c")
